...
互联网人的第一本数字家谱：让普通家庭也能简单、安全地保存世系、人物与家族记忆。

> 项目最初为穆氏家谱而建；现在穆氏家谱作为真实示范内容，产品本身面向所有希望建立家谱的家庭。“谱里”是本轮使用的工作品牌，正式发布前仍需完成商标、域名和公众号名称核验。

在线演示：[tatababa.top](https://tatababa.top)

## 产品定位

当前产品核心是：**让一个家庭低门槛地建立、浏览、续录和长期保存自己的数字家谱。**

长期定位：**以中国传统家谱为入口、以家庭记忆与资料传承为差异化的隐私优先协作档案。**

首批用户聚焦中国大陆的互联网从业者与国学爱好者，通过创始人的真实家谱和身边社交资源冷启动。公益性代表基础能力长期可用，不代表家谱默认公开。
...
3. 完成邀请、成员管理、字段级隐私和人物增量编辑。
4. 在保留传统父系谱展示的前提下，引入关系、来源和审核模型。
5. 再做 OCR 审核、时间线、口述史与家族年鉴成果物。

完整产品与技术规格见 [SPEC.md](./SPEC.md)，本轮完整结论见 [产品与架构升级评审](./docs/PRODUCT_STRATEGY_AND_ARCHITECTURE.md)。历史修复记录见 [docs/README.md](./docs/README.md)。

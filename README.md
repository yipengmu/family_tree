...
- 私密家谱与人物志可在浏览器本地生成朋友圈长图；家谱 Owner 还可以显式发布一份固定 7 天有效的在线家谱快照。在线页展示真实姓名、代际、树状关系、聚合摘要和家谱文化内容，但不包含照片、精确生日、地域、住址、联系方式、证件、人物志或原始材料；分享人和查看人都能看到精确到期时间，Owner 可提前撤销或更新后重新生成链接。

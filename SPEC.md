...
本项目是一个面向中国大陆普通家庭的隐私优先数字家谱：访客可浏览穆氏示范家谱；注册用户拥有独立家谱空间，可查看世系、搜索人物、续录资料并安全保存。

定位：**互联网人的第一本数字家谱；以中国传统家谱为入口，以家庭记忆和资料传承为长期差异化。**

默认隐私：家谱私密、仅受邀成员访问、在世人物敏感信息受保护、公开分享由 Owner 主动开启。

当前主导航固定为：`看家谱`、`续家谱`、`家族设置`。穆氏仅是示范家谱，不再作为平台品牌。
